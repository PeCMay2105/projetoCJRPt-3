    ...
    let novoPostHTML = `
        <div class="comment post white-blue-bg">
            <div class="info-person">
                <a href="" class="a-img"><img class="img-person" src="./assets/img/shinji.jpg" alt="foto de perfil"></a>
            ...
            <div class="vector">
                <button type="button" class="button-img" id="open-modal">
                    <img src="./assets/img/balao-de-fala.svg" alt="Ícone de balão">
                </button>
            </div>
        </div>`;
